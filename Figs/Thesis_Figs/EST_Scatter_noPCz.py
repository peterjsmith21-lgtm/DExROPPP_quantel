...
DEXROPPP = [-0.083, -0.087, -0.028, -0.073, -0.085,
               0.011, 0.015, -0.087, -0.087,  0.024, -0.050]
experimental = [ -0.065, -0.014, -0.0005, 0, 0, 0, 0,
                -0.044, -0.031, 0.0007, -0.0015]
...
plt.tight_layout()
plt.savefig("EST_Scatter_noPCz.png", dpi=300, transparent=True)
plt.show()
