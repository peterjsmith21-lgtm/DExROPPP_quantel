...
experimental = [
    ...
    2.182746479, 2.283241252, 1.579363057,
...
DEXROPPP = [
    ...
    (1.958609795, 2.0), (2.499596774, 0.0),
...
B3LYP = [
    ...
    (1.631315789, 1.09), (1.655273698, 1.02),
...
def make_scatter(ax, exp_vals, calc_data, method_label):
    ...
    ax.set_xticks(np.arange(1.2, 2.9, 0.4))
    ax.set_yticks(np.arange(1.2, 2.9, 0.4))
    ax.set_aspect('equal')
    ax.set_xlabel('Exp. Transition Energy / eV', fontsize=11)
    ax.set_ylabel(f'Calculated Transition Energy / eV', fontsize=11)
...
plt.savefig('absorption_scatter_noPCz.png', dpi=300, bbox_inches='tight', transparent=True)
plt.show()